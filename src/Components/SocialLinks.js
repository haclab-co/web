import { FacebookFilled, FacebookOutlined, GithubOutlined, InstagramFilled, InstagramOutlined, LinkedinFilled, LinkedinOutlined, TwitterOutlined, WhatsAppOutlined } from '@ant-design/icons'
...
const SocialLinks = () => {
    return (
        <div className='site-icons'>
            ...
            <a target='_blink' href='https://github.com/hytechlab'><GithubOutlined className='icon' /></a>
        </div>
    )
}
